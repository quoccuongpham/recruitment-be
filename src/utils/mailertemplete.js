                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                <strong>Đơn ứng tuyển của bạn đã được chấp nhận</strong>
                                                            </h1>
                                                        ...
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-font-size"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 18px; line-height: 25.2px;"><strong>Company
                                                                            Name</strong></span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div class="v-font-size"
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;">123 Ninh
                                                                    Kieu, Can Tho, VietNam</p>
                                                            </div>
                                                                            ...
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    ...
                                                                                    <a href="https://facebook.com/"
                                                                                        title="Facebook"
                                                                                        target="_blank">
                                                                                        <img src="https://static-00.iconduck.com/assets.00/facebook-icon-512x511-ircc9ves.png"
                                                                                            alt="Facebook"
